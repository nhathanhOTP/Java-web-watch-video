		...
		<nav class="navbar navbar-default top-navbar" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html"><i class="fa fa-gear"></i>
					<strong>SERVICE OE</strong></a>
			</div>

			<ul class="nav navbar-top-links navbar-right">
				<li class="dropdown">
					<p id="wellcomeName" style="display:${display1}">
						<a href="/PS16500_Lab6/account/loadProfile"> Wellcome,
							${sessionScope.fullname}</a>
					</p>
				</li>
		...
		<nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li><a href="/PS16500_Lab6/user/index" class="active-menu"><i
		...
		<div id="page-wrapper">
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						<h1 class="page-header">
							Users & manager <small>Users manager and edit</small>
						</h1>
					</div>
				</div>
				<!-- /. ROW  -->
				<div class="row">
					<div class="col-md-12">
						<%--From --%>
						<jsp:include page="/admin/managerUser.jsp"></jsp:include>
					</div>
				</div>
				<!-- /. ROW  -->
				<footer>
